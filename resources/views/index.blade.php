...
<head>
    ...
    <link rel="stylesheet" href="customs.html">
...
<body>
            ...
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-center">
                    <a href="index.html" class="navbar-brand ms-lg-5">
                        <h1 class="m-0 display-4 text-primary"><span class="text-secondary">Farmers</span>Connect</h1>
                    </a>
                </div>
            </div>
            <div class="col-lg-3">
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex d-lg-none">
            <h1 class="m-0 display-4 text-secondary"><span class="text-white">Farmers</span>Connect</h1>
        </a>
            ...
            <div class="navbar-nav mx-auto py-0">
                ...
                <!-- <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="team.html" class="dropdown-item">Featured Farmers</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Connecting Farmers with consumers</h3>
                            <h1 class="display-1 text-white mb-md-4">From Farm To Fork</h1>
                            <a href="about.html" class="btn btn-primary py-md-3 px-md-5 me-3">Explore</a>
                            <a href="contact.html" class="btn btn-secondary py-md-3 px-md-5">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="images/tomato.jpg" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Connecting Farmers with consumers</h3>
                            <h1 class="display-1 text-white mb-md-4">From Farm to fork</h1>
            ...
            <div class="row gx-0">
                <div class="col-md-6">
                    <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">BUY PRODUCE</h3>
                        <p class="text-white"></p>
                        <a class="text-white fw-bold" href="product.html"><i class="bi bi-arrow-right ms-2"></i></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="bg-secondary bg-fruit d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">SELL PRODUCE</h3>
                        <p class="text-white"></p>
                        <a class="text-white fw-bold" href=""><i class="bi bi-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        ...
                        <h1 class="display-5">Are You passionate about fresh, locally sourced produce? Look no further! </h1>
                    </div>
                    <p class="mb-4">Farmers connect is your one-stop destination for connecting with farmers and accessing the freshest produce right from the farm to your table.
                        We're passionate about revolutionizing the way food is sourced and consumed. Our platform serves as a digital marketplace, connecting farmers directly with consumers, bypassing traditional middlemen and ensuring fair prices for both parties.  With a focus on transparency, sustainability, and community, we're committed to fostering a healthier and more equitable food system.
                        </p>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="mb-3">
                        ...
                        <h1 class="display-5">Your Source For Freshness</h1>
                    </div>
                    <p class="mb-4">We're dedicated to bringing you the freshest and highest quality products, directly from local farmers to your table. Explore our wide range of offerings and discover the convenience and freshness that Farmers connect has to offer.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light text-center p-5">
                        ...
                        <h4>Farming Plans</h4>
                        <p class="mb-0"></p>
                        <BUTton ><a href="service.html">PREMIUM</a></BUTton>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel p-5">
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto p-2 border border-5 border-secondary rounded-circle mb-4" src="img" alt="">
                            <p class="fs-5"></p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0"></h4>
                        </div>
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto p-2 border border-5 border-secondary rounded-circle mb-4" src="" alt="">
                            <p class="fs-5"></p>
                            <hr class="mx-auto w-25">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                <h6 class="text-primary text-uppercase">Featured Farmers</h6>
                <h1 class="display-5">Local heroes committed to sustainable farming.</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="images/about2.png" alt="">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Jane Wanjiku</h4>
                                    <span class="text-white">Vegetable Farmer</span>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="col-2">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="images/test.jpg" alt="">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Chelsea Ryan</h4>
                                    <span class="text-white">Cereal Farmer</span>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="col-2">
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Justus Tuno</h4>
                                    <span class="text-white">Dairy Farmer</span>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="col-2">
                ...
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden">
                        ...
                        <a class="blog-overlay" href="">
                            ...
                            <span class="text-white fw-bold">Waste management</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden">
                        ...
                        <a class="blog-overlay" href="">
                            <h4 class="text-white"></h4>
                            <span class="text-white fw-bold">Smart Agriculture</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden">
                        ...
                        <a class="blog-overlay" href="">
                            <h4 class="text-white"></h4>
                            <span class="text-white fw-bold">Soiless Farming</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">Farmersconnect@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-white me-2"></i>
                                <p class="text-white mb-0">+254</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-n5">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-secondary p-5">
                        ...
                        <p>To receive emails and news</p>
                        <form action="">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#"> @ 2024 Farmersconnect.com</a>. All Rights Reserved.</a></p>
        </div>
